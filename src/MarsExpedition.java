...
//        You need to use input.nextLine() to correct the location of the scanner after using nextInt()
            input.nextLine();
//        Use an if statement to check if teamSize is greater than 2 Print “That’s way to many people. We can only send 2 more members.” Set teamSize equal to 2
            if (teamSize > 2) {
                System.out.println("That's way to many people. We can only send 2 more members.");
                teamSize = 2;

//        Use an else-if statement to check if teamSize is less than 2 Print “That’s not enough people. We need you and 2 more members.” Set teamSize equal to 2
            } else if (teamSize < 2) {
...
//        Use an if statement to check if vehicleChoice is equal to A ignoring case Create a new String variable called vehicle and set it equal to “Mars Roover”
            if (vehicleChoice.equalsIgnoreCase("A")) {
                vehicle = "Mars Roover";
            } else if (vehicleChoice.equalsIgnoreCase("B")) {
//        Use an else if statement to check if vehicleChoice is equal to B ignoring case Create a new String variable called vehicle and set it equal to “Chevy Silverado”
                vehicle = "Chevy Silverado";
//        Use an else if statement to check if vehicleChoice is equal to C ignoring case Create a new String variable called vehicle and set it equal to “Honda Civic”
            } else if (vehicleChoice.equalsIgnoreCase("C")) {
                vehicle = "Honda Civic";
            } else { //Use an else statement for if vehicleChoice does not equal any of the above Create a new String variable called vehicle and set it equal to “your feet”
                vehicle = "your feet";

            }
//             Print “Your expedition team is now ready” “nLed by name with teamSize teammates.” “nTo explore the surface of Mars using vehicle.” “nExploration team heads out in” “n5….” “n4….” “n3….” “n2….” “n1….” “nGO GO GO!”
