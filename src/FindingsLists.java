...
//
//        You will be adding 4 rocks to the list using rockList.add(“”) rock, weird rock, smooth rock, and not rock
        rockList.add("rock");
...
//        Use Thread.sleep(500) to stop the terminal for half a second
        Thread.sleep(500);
//
//        Create a Hashmap<String, String> named fossilDirectory and set it equal to new Hashmap<>() Hashmap<String, String> allows each fossilDirectory element to have 2 attributes, like name and description
        HashMap<String, String> fossilDirectory = new HashMap<String,String>();
//
//        Print “Fossil data downloaded”
        System.out.println("Fossil data downloaded");
//
//        You will be adding 3 fossils and their description to the Hashmap using fossilDirectory.put(“”,””) Bird Fossil, The fossil has wings implying it was capable of flight Fish Fossil, The fossil is vaguely fish shaped implies there was once water Tooth Fossil, The tooth from an unknown fossil
...
//        Create an if statement that checks if fossilChoice equals “Bird Fossil” Print “Fossil: fossilChoice nDescription: fossilDirectory.get(fossilChoice)
        if(fossilChoice.equals("Bird Fossil")) {
            System.out.println("Fossil: " + fossilChoice + "\nDescription: " + fossilDirectory.get(fossilChoice));
//        Create an else if statement to check if fossilChoice equals “Fish Fossil” Print “Fossil: fossilChoice nDescription: fossilDirectory.get(fossilChoice)
        }else if(fossilChoice.equals("Fish Fossil")) {
            System.out.println("Fossil: " + fossilChoice + "\nDescription: " + fossilDirectory.get(fossilChoice));
//        Create an else if statement to check if fossilChoice equals “Tooth Fossil” Print “Fossil: fossilChoice nDescription: fossilDirectory.get(fossilChoice)
